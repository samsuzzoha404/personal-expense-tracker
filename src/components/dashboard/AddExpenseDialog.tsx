  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[550px] p-0 overflow-hidden">
        ...
        <div className="bg-gradient-to-br from-primary/10 via-purple-500/10 to-pink-500/10 p-6 border-b border-border/50">
          <DialogHeader>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="h-11 pl-10 bg-secondary/50 text-lg font-semibold"
                          />
                        </div>
                      </FormControl>
                      <FormMessage />
                      ...
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button
                            variant="outline"
                            className={cn(
                              "w-full h-11 pl-3 text-left font-normal bg-secondary/50",
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className="resize-none bg-secondary/50 min-h-[80px]"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <div className="flex gap-3 pt-4">
                ...
                <Button 
                  type="submit" 
                  className="flex-1 h-11 gradient-primary hover-glow font-semibold" 
